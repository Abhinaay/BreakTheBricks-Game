...
public class Bricks1 extends Thread implements KeyListener,MouseMotionListener 
{
	JFrame jf;
	...
	{	
		...
		jf.setLayout(bl);
		jf.setContentPane(new JLabel(new ImageIcon("pic\\bg21.jpg")));
		//jf.setCursor(Cursor.getPredefinedCursor(null));
		...
		jf.add(BorderLayout.CENTER,jp1=new JPanel());
			...
			jp1.setOpaque(false);
			jp1.setLayout(null);
			jp1.add(bat=new JLabel(new ImageIcon("pic\\bat1.png")));
			jp1.add(ball=new JLabel(new ImageIcon("pic\\ball1.png")));
			jp1.add(jp3=new JPanel());
			jp3.setOpaque(false);
			jp3.add(life1=new JLabel(new ImageIcon("pic\\heart2.png","1")));
			jp3.add(life2=new JLabel(new ImageIcon("pic\\heart2.png","2")));
			jp3.add(life3=new JLabel(new ImageIcon("pic\\heart2.png","3")));
			...
			jp2.setOpaque(false);
				...
				jp2.add(jl2=new JLabel());				  							jp2.add(jl12=new JLabel(new ImageIcon("pic\\brick4.png","12")));
				jp2.add(jl3=new JLabel(new ImageIcon("pic\\brick4.png","3")));		jp2.add(jl13=new JLabel(new ImageIcon("pic\\brick4.png","13")));
				jp2.add(jl4=new JLabel(new ImageIcon("pic\\brick4.png","4")));		jp2.add(jl14=new JLabel());
				jp2.add(jl5=new JLabel());											jp2.add(jl15=new JLabel());
				jp2.add(jl6=new JLabel(new ImageIcon("pic\\brick4.png","6")));		jp2.add(jl16=new JLabel());
				jp2.add(jl7=new JLabel(new ImageIcon("pic\\brick4.png","7")));		jp2.add(jl17=new JLabel());
				jp2.add(jl8=new JLabel(new ImageIcon("pic\\brick5.png","8")));		jp2.add(jl18=new JLabel(new ImageIcon("pic\\brick5.png","18")));
				jp2.add(jl9=new JLabel());											jp2.add(jl19=new JLabel(new ImageIcon("pic\\brick4.png","19")));
				jp2.add(jl10=new JLabel());											jp2.add(jl20=new JLabel(new ImageIcon("pic\\brick4.png","20")));
				
				jp2.add(jl21=new JLabel());											jp2.add(jl31=new JLabel(new ImageIcon("pic\\brick4.png","31")));		
				jp2.add(jl22=new JLabel());											jp2.add(jl32=new JLabel(new ImageIcon("pic\\brick5.png","32")));
				jp2.add(jl23=new JLabel());											jp2.add(jl33=new JLabel());
				jp2.add(jl24=new JLabel(new ImageIcon("pic\\brick5.png","24")));	jp2.add(jl34=new JLabel());
				jp2.add(jl25=new JLabel(new ImageIcon("pic\\brick4.png","25")));	jp2.add(jl35=new JLabel());
				jp2.add(jl26=new JLabel());											jp2.add(jl36=new JLabel(new ImageIcon("pic\\brick4.png","36")));
				jp2.add(jl27=new JLabel(new ImageIcon("pic\\brick5.png","27")));	jp2.add(jl37=new JLabel(new ImageIcon("pic\\brick5.png","37")));
				jp2.add(jl28=new JLabel(new ImageIcon("pic\\brick5.png","28")));	jp2.add(jl38=new JLabel(new ImageIcon("pic\\brick5.png","38")));
				jp2.add(jl29=new JLabel(new ImageIcon("pic\\brick5.png","29")));	jp2.add(jl39=new JLabel(new ImageIcon("pic\\brick5.png","39")));
				jp2.add(jl30=new JLabel(new ImageIcon("pic\\brick4.png","30")));	jp2.add(jl40=new JLabel());
				
				jp2.add(jl41=new JLabel());											jp2.add(jl51=new JLabel(new ImageIcon("pic\\brick4.png","51")));		
				jp2.add(jl42=new JLabel(new ImageIcon("pic\\brick5.png","42")));	jp2.add(jl52=new JLabel(new ImageIcon("pic\\brick5.png","52")));
				jp2.add(jl43=new JLabel(new ImageIcon("pic\\brick5.png","43")));	jp2.add(jl53=new JLabel(new ImageIcon("pic\\brick5.png","53")));
				jp2.add(jl44=new JLabel(new ImageIcon("pic\\brick5.png","44")));	jp2.add(jl54=new JLabel(new ImageIcon("pic\\brick5.png","54")));
				jp2.add(jl45=new JLabel(new ImageIcon("pic\\brick4.png","45")));	jp2.add(jl55=new JLabel());
				jp2.add(jl46=new JLabel());											jp2.add(jl56=new JLabel(new ImageIcon("pic\\brick4.png","56")));
				jp2.add(jl47=new JLabel());											jp2.add(jl57=new JLabel(new ImageIcon("pic\\brick5.png","57")));
				jp2.add(jl48=new JLabel());											jp2.add(jl58=new JLabel());
				jp2.add(jl49=new JLabel(new ImageIcon("pic\\brick5.png","49")));	jp2.add(jl59=new JLabel());
				jp2.add(jl50=new JLabel(new ImageIcon("pic\\brick4.png","50")));	jp2.add(jl60=new JLabel());
				
				jp2.add(jl61=new JLabel(new ImageIcon("pic\\brick4.png","61")));	jp2.add(jl71=new JLabel());		
				jp2.add(jl62=new JLabel(new ImageIcon("pic\\brick4.png","62")));	jp2.add(jl72=new JLabel());
				jp2.add(jl63=new JLabel(new ImageIcon("pic\\brick5.png","63")));	jp2.add(jl73=new JLabel(new ImageIcon("pic\\brick5.png","73")));
				jp2.add(jl64=new JLabel());											jp2.add(jl74=new JLabel(new ImageIcon("pic\\brick4.png","74")));
				jp2.add(jl65=new JLabel());											jp2.add(jl75=new JLabel(new ImageIcon("pic\\brick4.png","75")));
				jp2.add(jl66=new JLabel());											jp2.add(jl76=new JLabel());
				jp2.add(jl67=new JLabel());											jp2.add(jl77=new JLabel(new ImageIcon("pic\\brick4.png","77")));
				jp2.add(jl68=new JLabel());											jp2.add(jl78=new JLabel());
				jp2.add(jl69=new JLabel(new ImageIcon("pic\\brick4.png","69")));	jp2.add(jl79=new JLabel());
				...
				jp2.add(jl83=new JLabel(new ImageIcon("pic\\brick4.png","83")));	jp2.add(jl93=new JLabel(new ImageIcon("pic\\brick4.png","93")));
